  ...
  return (
    <div className="flex w-full px-4 lg:px-40 py-4 items-center border-b text-center gap-8 justify-between">
      ...
      <div className="flex gap-4 lg:ml-auto">
        {!user && (
          <Link href="/login" className="inline-flex w-100 items-center rounded-full shadow-xl hover:shadow-2xl bg-gray-900 dark:bg-gray-900 text-white text-sm font-normal px-1 py-1">
