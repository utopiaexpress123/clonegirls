        ...
        <UploadIcon/>
          ...
          <div>
            <Link href="/overview/models/train">
              <Button size={"lg"} variant={"default"} className="rounded-full border border-gray-200 hover:border-fuchsia-300 bg-gray-700 hover:bg-gray-600 shadow-xl hover:shadow-lg shadow-fuchsia-300/50 hover:shadow-fuchsia-400/60">
                <span className="mr-4">
                  <MagicIcon/>
                </span>
                Upload some photos
...
function UploadIcon() {
  return (
<svg className="text-gray-500 w-16 h-16" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1} stroke="currentColor">
