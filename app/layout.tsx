...
export default function RootLayout({ children }: any) {
  return (
    <html lang="en">
      <body className={cn(
          "min-h-screen bg-background font-sans antialiased bg-gradient-to-tl from-fuchsia-50 to-slate-300",
          fontSans.variable
        )}>
          <section>
          ...
          <main className="flex flex-1 flex-col items-center py-1 pt-14 md:w-3/5">
            {children}
          </main>
          <Toaster />
      </body>
